...
os.environ['SCRIPTDIR']
xml_file = Path(os.environ['SCRIPTDIR']) / "www/xml/Assessment_target_MFT1.2_4_MP_06.xml"
...
template = "Mangrove-profile.docx"
...
document.write(ucode+'-'+uname+'.docx')

...
meow_mgv_summary %<>% mutate(description=case_when(
  ...
  ECO_CODE %in% c(20175) ~ "Merged to keep continuity in distribution",
  ...
  PROV_CODE %in% c(12,17,20,19,18,23,24,27,26,25,30,29,31,35) ~ "Kept as part of distinct unit",
  ECO_CODE %in% c(20105) ~ "Unmapped but known occurrence",
